...
class FirstAidStepsNotifier extends StateNotifier<List<bool>> {
  ...
  FirstAidStepsNotifier(String id, int length)
      : super(_stepState[id] ?? List<bool>.filled(length, false));
...
final firstAidStepsProvider =
    StateNotifierProvider.family<FirstAidStepsNotifier, List<bool>, String>(
  (ref, id) {
